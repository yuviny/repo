 ...
 */
public interface ImpartitionPlanDao
{
    /**
    ...
    /**
     * Loads an instance of finf.ucf.cu.domain.ImpartitionPlan from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link finf.ucf.cu.domain.ImpartitionPlan}.
     *
    ...
    /**
     * Creates an instance of finf.ucf.cu.domain.ImpartitionPlan and adds it to the persistent store.
     */
    public finf.ucf.cu.domain.ImpartitionPlan create(finf.ucf.cu.domain.ImpartitionPlan impartitionPlan);

    /**
     * <p>
     * Does the same thing as {@link #create(finf.ucf.cu.domain.ImpartitionPlan)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, finf.ucf.cu.domain.ImpartitionPlan impartitionPlan);

    /**
     * Creates a new instance of finf.ucf.cu.domain.ImpartitionPlan and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of finf.ucf.cu.domain.ImpartitionPlan
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>finf.ucf.cu.domain.ImpartitionPlan</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.lang.Boolean)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Updates the <code>impartitionPlan</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of finf.ucf.cu.domain.ImpartitionPlan from the persistent store.
     */
    public void remove(finf.ucf.cu.domain.ImpartitionPlan impartitionPlan);

    /**
     * Removes the instance of finf.ucf.cu.domain.ImpartitionPlan having the given
     ...
     * </p>
     */
    public finf.ucf.cu.domain.ImpartitionPlan findbyId(String queryString, java.lang.Long id);
