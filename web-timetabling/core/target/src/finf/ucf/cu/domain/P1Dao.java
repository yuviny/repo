...
public interface P1Dao
{
    ...
    /**
     * Loads an instance of finf.ucf.cu.domain.P1 from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link finf.ucf.cu.domain.P1}.
     *
    ...
    /**
     * Creates an instance of finf.ucf.cu.domain.P1 and adds it to the persistent store.
     */
    public finf.ucf.cu.domain.P1 create(finf.ucf.cu.domain.P1 p1);

    /**
     * <p>
     * Does the same thing as {@link #create(finf.ucf.cu.domain.P1)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, finf.ucf.cu.domain.P1 p1);

    /**
     * Creates a new instance of finf.ucf.cu.domain.P1 and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of finf.ucf.cu.domain.P1
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>finf.ucf.cu.domain.P1</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.lang.String, java.util.Date, java.lang.String)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Updates the <code>p1</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of finf.ucf.cu.domain.P1 from the persistent store.
     */
    public void remove(finf.ucf.cu.domain.P1 p1);

    /**
     * Removes the instance of finf.ucf.cu.domain.P1 having the given
     ...
     * </p>
     */
    public finf.ucf.cu.domain.P1 findbyid(String queryString, java.lang.Long id);
