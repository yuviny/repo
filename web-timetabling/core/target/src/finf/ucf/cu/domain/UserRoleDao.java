...
public interface UserRoleDao
{
     ...
     * {@link finf.ucf.cu.vo.UserRoleVO}.
     */
    public final static int TRANSFORM_USERROLEVO = 1;
    ...
    /**
     * Converts this DAO's entity to an object of type {@link finf.ucf.cu.vo.UserRoleVO}.
     */
    public finf.ucf.cu.vo.UserRoleVO toUserRoleVO(finf.ucf.cu.domain.UserRole entity);

    /**
     * Converts this DAO's entity to a Collection of instances of type {@link finf.ucf.cu.vo.UserRoleVO}.
     */
    public void toUserRoleVOCollection(java.util.Collection entities);

    /**
     * Converts this DAO's entity to an array of instances of type {@link finf.ucf.cu.vo.UserRoleVO}.
     */
    public finf.ucf.cu.vo.UserRoleVO[] toUserRoleVOArray(java.util.Collection entities);

    /**
     * Copies the fields of {@link finf.ucf.cu.vo.UserRoleVO} to the specified entity.
    ...
    /**
     * Converts an instance of type {@link finf.ucf.cu.vo.UserRoleVO} to this DAO's entity.
     */
    public finf.ucf.cu.domain.UserRole userRoleVOToEntity(finf.ucf.cu.vo.UserRoleVO userRoleVO);

    /**
     * Converts a Collection of instances of type {@link finf.ucf.cu.vo.UserRoleVO} to this
     * DAO's entity.
     */
    public void userRoleVOToEntityCollection(java.util.Collection instances);

    /**
     * Loads an instance of finf.ucf.cu.domain.UserRole from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link finf.ucf.cu.domain.UserRole}.
     *
    ...
    /**
     * Creates an instance of finf.ucf.cu.domain.UserRole and adds it to the persistent store.
     */
    public finf.ucf.cu.domain.UserRole create(finf.ucf.cu.domain.UserRole userRole);

    /**
     * <p>
     * Does the same thing as {@link #create(finf.ucf.cu.domain.UserRole)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, finf.ucf.cu.domain.UserRole userRole);

    /**
     * Creates a new instance of finf.ucf.cu.domain.UserRole and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of finf.ucf.cu.domain.UserRole
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>finf.ucf.cu.domain.UserRole</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(finf.ucf.cu.domain.Role)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Removes the instance of finf.ucf.cu.domain.UserRole from the persistent store.
     */
    public void remove(finf.ucf.cu.domain.UserRole userRole);

    /**
     * Removes the instance of finf.ucf.cu.domain.UserRole having the given
