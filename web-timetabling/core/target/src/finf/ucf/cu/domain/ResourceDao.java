...
public interface ResourceDao
{
    ...
    /**
     * Loads an instance of finf.ucf.cu.domain.Resource from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link finf.ucf.cu.domain.Resource}.
     *
    ...
    /**
     * Creates an instance of finf.ucf.cu.domain.Resource and adds it to the persistent store.
     */
    public finf.ucf.cu.domain.Resource create(finf.ucf.cu.domain.Resource resource);

    /**
     * <p>
     * Does the same thing as {@link #create(finf.ucf.cu.domain.Resource)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, finf.ucf.cu.domain.Resource resource);

    /**
     * Creates a new instance of finf.ucf.cu.domain.Resource and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of finf.ucf.cu.domain.Resource
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>finf.ucf.cu.domain.Resource</code>
    ...
    /**
     * Updates the <code>resource</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of finf.ucf.cu.domain.Resource from the persistent store.
     */
    public void remove(finf.ucf.cu.domain.Resource resource);

    /**
     * Removes the instance of finf.ucf.cu.domain.Resource having the given
     ...
     * </p>
     */
    public finf.ucf.cu.domain.Resource findbyId(String queryString);
