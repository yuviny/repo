...
public interface ClassTypeDao
{
    ...
    /**
     * Loads an instance of finf.ucf.cu.domain.ClassType from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link finf.ucf.cu.domain.ClassType}.
     *
    ...
    /**
     * Creates an instance of finf.ucf.cu.domain.ClassType and adds it to the persistent store.
     */
    public finf.ucf.cu.domain.ClassType create(finf.ucf.cu.domain.ClassType classType);

    /**
     * <p>
     * Does the same thing as {@link #create(finf.ucf.cu.domain.ClassType)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, finf.ucf.cu.domain.ClassType classType);

    /**
     * Creates a new instance of finf.ucf.cu.domain.ClassType and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of finf.ucf.cu.domain.ClassType
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>finf.ucf.cu.domain.ClassType</code>
    ...
    /**
     * Updates the <code>classType</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of finf.ucf.cu.domain.ClassType from the persistent store.
     */
    public void remove(finf.ucf.cu.domain.ClassType classType);

    /**
     * Removes the instance of finf.ucf.cu.domain.ClassType having the given
     ...
     * </p>
     */
    public finf.ucf.cu.domain.ClassType findbyId(String queryString, java.lang.Long id);
