...
public interface SemesterDao
{
    ...
    /**
     * Loads an instance of finf.ucf.cu.domain.Semester from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link finf.ucf.cu.domain.Semester}.
     *
    ...
    /**
     * Creates an instance of finf.ucf.cu.domain.Semester and adds it to the persistent store.
     */
    public finf.ucf.cu.domain.Semester create(finf.ucf.cu.domain.Semester semester);

    /**
     * <p>
     * Does the same thing as {@link #create(finf.ucf.cu.domain.Semester)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, finf.ucf.cu.domain.Semester semester);

    /**
     * Creates a new instance of finf.ucf.cu.domain.Semester and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of finf.ucf.cu.domain.Semester
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>finf.ucf.cu.domain.Semester</code>
    ...
    /**
     * Updates the <code>semester</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of finf.ucf.cu.domain.Semester from the persistent store.
     */
    public void remove(finf.ucf.cu.domain.Semester semester);

    /**
     * Removes the instance of finf.ucf.cu.domain.Semester having the given
     ...
     * </p>
     */
    public finf.ucf.cu.domain.Semester findById(String queryString, java.lang.Long id);
