 ...
 * 
 */
public abstract class GroupScheduleController implements java.io.Serializable
{
    /**
     * The serial version UID of this class. Needed for serialization.
     */
    private static final long serialVersionUID = -2101049320392414707L;

    /**
     * 
     */
    public abstract void loadSchedule(org.apache.struts.action.ActionMapping mapping, finf.ucf.cu.web.groupschedule.LoadScheduleForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception;
    ...
    /**
     * Returns a reference to the uno back-end service.
     */
    protected final finf.ucf.cu.service.GroupScheduleService getUno()
        throws java.lang.Exception
    {
        return finf.ucf.cu.ServiceLocator.instance().getGroupScheduleService();
    }

    /**
     * Returns a reference to the roomService back-end service.
     */
    protected final finf.ucf.cu.service.RoomService getRoomService()
        throws java.lang.Exception
    {
        return finf.ucf.cu.ServiceLocator.instance().getRoomService();
    }
