...
public class GroupScheduleBuscarFormImpl
        ...
        , finf.ucf.cu.web.groupschedule.LoadScheduleForm
{
    ...
    public GroupScheduleBuscarFormImpl()
    {
    ...
    public void setExportBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        ...
        {
            throw new IllegalArgumentException("GroupScheduleBuscarFormImpl.setExportBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GroupScheduleBuscarFormImpl.setExportBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see finf.ucf.cu.web.groupschedule.GroupScheduleBuscarFormImpl#getDay
     * @see finf.ucf.cu.web.groupschedule.GroupScheduleBuscarFormImpl#dayDateFormatter
     */
     ...
     *
     * @see finf.ucf.cu.web.groupschedule.GroupScheduleBuscarFormImpl#getDayAsDate
     * @see finf.ucf.cu.web.groupschedule.GroupScheduleBuscarFormImpl#getDayDateFormatter
     */
    ...
    {
        return GroupScheduleBuscarFormImpl.dayDateFormatter;
    }
    ...
    public void setDayBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("GroupScheduleBuscarFormImpl.setDayBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GroupScheduleBuscarFormImpl.setDayBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public void setMygroupBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("GroupScheduleBuscarFormImpl.setMygroupBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GroupScheduleBuscarFormImpl.setMygroupBackingList encountered an exception", ex);
            }
        }
    }
     ...
     *
     * @see finf.ucf.cu.web.groupschedule.GroupScheduleBuscarFormImpl#getGroupSchedule
     */
    ...
    public void setGroupScheduleBackingList(java.util.Collection items, java.lang.String valueProperty, java.lang.String labelProperty)
    {
        if (valueProperty == null || labelProperty == null)
        {
            throw new IllegalArgumentException("GroupScheduleBuscarFormImpl.setGroupScheduleBackingList requires non-null property arguments");
        }
        ...
        if (items != null)
        {
            ...
            {
                throw new java.lang.RuntimeException("GroupScheduleBuscarFormImpl.setGroupScheduleBackingList encountered an exception", ex);
            }
        }
    }
    ...
    public org.apache.struts.action.ActionErrors validate(org.apache.struts.action.ActionMapping mapping, javax.servlet.http.HttpServletRequest request)
    {
        ...
        if (errors != null && !errors.isEmpty())
        {
            ...
            if (currentForm != null)
            {
                ...
                try
                {
                    resetMethods.put("resetExport", currentFormClass.getMethod("resetExport", null));
